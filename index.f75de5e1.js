...
document.addEventListener("click", (e)=>{
    ...
    const leftPosition = Math.max(0, Math.min(x - spider.clientWidth / 2, spiderContainer.clientWidth - spider.clientWidth));
    const topPosition = Math.max(0, Math.min(y - spider.clientHeight / 2, spiderContainer.clientHeight - spider.clientHeight));
